...
const smallcircle = (props: Props) => {
  return (
    ...
    >
      ...
      <div className="absolute border border-gray-400 h-[250px] w-[250px] rounded-full" />
      <div className="absolute border border-gray-400 h-[200px] w-[200px] rounded-full animate-pulse" />
      <div className="absolute border border-gray-400 h-[150px] w-[150px] rounded-full animate-pulse" />
    </motion.div>
  )
}
